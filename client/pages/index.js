...
const style = {
  ...
  walletConnectButton: `text-2xl text-black bg-white font-bold mb-[-3rem] mt-[3rem]
  px-6 py-4 rounded-full cursor-pointer hover:bg-[#d7dbdc]`,
...
const Home = () => {
  ...
  const error = (
    <div className={style.loginContainer}>
      ...
      <div className={style.loginContent}>
        Oupps, there is An error occurred. Please try again later or from another browser.
      </div>
    </div>
  )
